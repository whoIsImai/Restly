        ...
        <div className="px-40 flex flex-1 justify-center py-5">
          <div className="layout-content-container flex flex-col max-w-[960px] flex-1">
            ...
            <p className="text-[#141414] text-base font-normal leading-normal pb-3 pt-1 px-4">
              Restly is a leading online platform connecting renters with property owners. Our mission is to simplify the rental process, making it more transparent and efficient
            ...
            <p className="text-[#141414] text-base font-normal leading-normal pb-3 pt-1 px-4">
              Founded in 2015, Restly began as a small startup with a big vision: to revolutionize the rental market. Over the years, we've grown into a trusted platform, serving
